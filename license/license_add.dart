...
import 'package:driveCo/src/Document_wallet/license/license_view.dart';
import 'package:driveCo/src/app_configs/app_colors.dart';
import 'package:driveCo/src/app_configs/app_images.dart';
import 'package:flutter/material.dart';

class LicenseAdd extends StatelessWidget {
  const LicenseAdd({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: Image.asset(
            AppImages.arrowBack,color: AppColors.outlineBorderColor,width: 32,height: 32,),
          onPressed: () {
            Navigator.of(context).pop();
          },
        ),
        title: const Text(
          'Take a photo of your driving\nlicense',
          style: TextStyle(
